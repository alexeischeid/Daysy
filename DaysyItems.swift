...
let pecsCategories: [[String]] = [/*suggestedIcons, */activities, school, emotions, bodyParts, clothing,  food, seasonsTime, vehicles, nature, allPECS]
//had to comment out suggested icons, find a better way to handle. the dynamic grid only acounts for default icons when iterating through categories, chould probably have suggested icons up top anyways.
